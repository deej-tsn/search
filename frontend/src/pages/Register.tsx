        ...
        <div className="w-full h-fit sm:w-3/4 md:w-3/5 lg:w-[600px] rounded-2xl drop-shadow-lg bg-white p-4">
            <form className=" w-full flex flex-col items-center" onSubmit={createPOST}>
                <div className="w-full flex flex-col mb-5">
                    <input className = "p-2 rounded-lg border mb-5" type="text" name="username" required id="username" placeholder="Username"></input>
                    <input className = "p-2 rounded-lg border mb-5" type="text" name="fname" required id="fname" placeholder="First Name"></input>
                    <input className = "p-2 rounded-lg border mb-5" type="text" name="sname" required id="sname" placeholder="Second Name"></input>
                    ...
                    {password_error_msg !== "" && <div className="mx-auto p-2 text-red-500">{password_error_msg}</div>}
                </div>
